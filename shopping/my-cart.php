				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continuer les achats</a>
								<input type="submit" name="submit" value="Mettre a jour le panier" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Address de Livraison</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Addresse de Facturation </span>
				</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">PROCEDER A LA COMMANDE</button>
