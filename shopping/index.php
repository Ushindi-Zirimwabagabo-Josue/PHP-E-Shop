						...
						<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
							...
							<div id="hero" class="homepage-slider3">
								<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
									...
									<div class="full-width-slider">
										<div class="item full-width-slider" style="background-image: url(assets/images/sliders/home-appliances-1.jpg);">
										</div><!-- /.item -->
									</div><!-- /.full-width-slider -->
									<div class="full-width-slider">
										<div class="item full-width-slider" style="background-image: url(assets/images/sliders/FB_IMG_16131287769145521.jpg);">
										</div><!-- /.item -->
									</div><!-- /.full-width-slider -->
									<div class="full-width-slider">
										<div class="item full-width-slider" style="background-image: url(assets/images/sliders/FB_IMG_16133316181754942.jpg);">
										</div><!-- /.item -->
									</div><!-- /.full-width-slider -->
									<div class="full-width-slider">
										<div class="item full-width-slider" style="background-image: url(assets/images/sliders/FB_IMG_16110053998621519.jpg);">
										</div><!-- /.item -->
									</div><!-- /.full-width-slider -->
									<div class="full-width-slider">
										<div class="item full-width-slider" style="background-image: url(assets/images/sliders/Screenshot_20180902-185946.jpg);">
										</div><!-- /.item -->
									</div><!-- /.full-width-slider -->
									<div class="full-width-slider">
										<div class="item full-width-slider" style="background-image: url(assets/images/sliders/Screenshot_20180902-185637.jpg);">
										</div><!-- /.item -->
									</div><!-- /.full-width-slider -->
									<div class="full-width-slider">
										<div class="item full-width-slider" style="background-image: url(assets/images/sliders/home_appliance.jpg);">
										</div><!-- /.item -->
									</div><!-- /.full-width-slider -->
									<div class="full-width-slider">
									...
									<div class="full-width-slider">
										<div class="item full-width-slider" style="background-image: url(assets/images/FB_IMG_16083975492960184.jpg);">
										</div><!-- /.item -->
									</div><!-- /.full-width-slider -->
								...
								<div class="product-slider">
									<div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
										...
										<div class="item item-carousel"">
											<div class="products" style="height: 500px;">	
												<div class="product" style="height: 480px;">		
													...
													<div class="product-info text-left" style="height: 140px;">
														<h3 class="name" style="height: 57px;"><a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['productName']);?></a></h3>
														<div class="rating rateit-small">
														</div>
														<div class="description">
														</div>
														<div class="product-price">	
															<span class="price" style="1px solid;">
													...
													<div class="action">
														<a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Ajouter au Panier</a>
													</div>
												</div><!-- /.product -->
											</div><!-- /.products -->
										</div><!-- /.item -->
								...
								<div class="item item-carousel">
									<div class="products">			
										<div class="product">		
											...
											<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Ajouter au Panier</a>
											</div>
										</div><!-- /.product -->
									</div><!-- /.products -->
								</div><!-- /.item -->
