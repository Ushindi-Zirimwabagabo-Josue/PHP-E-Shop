...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['productName']);?>/<?php echo htmlentities($rws['productImage1']);?>"  width="300" height="300" alt="">
							</div>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Marque du Produit :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
