...
?>
				<tr>
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('http://localhost/onlineshopping/shopping/track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					Track</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
