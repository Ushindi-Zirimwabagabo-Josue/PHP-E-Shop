...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Vos informations ont ete mis a jour');</script>";
		}
	}
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Mettre a Jour</button>
					</form>
					<?php } ?>
				</div>	
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">Confirmer le Mot de Passe <span>*</span></label>
					    <input type="password" class="form-control unicase-form-control text-input" id="cnfpass" name="cnfpass" required="required" >
					  </div>
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Changer </button>
					</form> 
