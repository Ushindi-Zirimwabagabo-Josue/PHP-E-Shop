...
<html lang="en">
	<head>
	    ...
	    <title>Ma liste des souhaits</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Liste des Souhaits</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">ma liste des souhaits</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Votre liste des souhaits est vide</td>
